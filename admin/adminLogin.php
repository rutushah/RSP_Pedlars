...
<body>
<h2 class = "font-weight-bold mt-5 text-center" id="login" >Welcome To RSP Pedlars Admin Login</h2>

<div class="container mt-5 mb-4">
    <div class="row justify-content-md-center">
        <div class="col-sm-6 border border-primary shadow rounded pt-2">
            <div class="col-sm-12">
              <form method="post" id="loginForm" action = "../phpFiles/checkAdminLogin.php" onSubmit="return validation();">
                ...
                <div class="form-group">
                  <input type="submit" name="adminlogin" value="Login" class="btn btn-default col-sm-12">
                </div>
              </form>
        </div>
      </div>
